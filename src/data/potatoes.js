...
const potatoes = [
  {
    ...
    tubers: "oblong; smooth dark purple with scattered tan skin; shallow eyes, evenly distributed; prominent eyebrows; blue-purple flesh.",
    yield: "",
    use: "",
    diseaseInfo: {
      "Field resistant": "",
    ...
    image: "src/assets/images/russet.jpg",
  },
  {
    name: "Red Chieftan",
    id: "red-chieftan",
    description: "",
    maturity: "mid-season",
    tubers: "oval to oblong, smooth bright red skin; shallow to medium-deep eyes, darker than the skin; white flesh. High yielding variety, attractive appearance, widely adapted. Well suited for washing at maturity. Good storability. Medium specific gravity.",
    yield: "",
  ...
  },
  {
    ...
    description: "",
    maturity: "mid-season",
    tubers: "oblong, slightly-flattened, smooth tubers covered with clear yellow skin. Sold by Across the Creek Organics as \"German Butter Potatoes\" this variety has been a true superstar potato.Loved by chefs and home cooks for its flavour, loved by farmers for it high yield of smooth tubers.",
    yield: "",
    use: "",
    diseaseInfo: {
      "Field resistant": "",
  ...
  },
  {
    ...
    tubers: "long to slightly oblong, smooth; heavy, dark tan, russeted and netted skin; shallow bright golden eyes, fairly numerous; many slightly curved eyebrows; white flesh.",
    yield: "Medium yielding variety, attractive appearance, uniform tuber size and shape. Wide adaptability. Resistant to hollow heart. Low to medium specific gravity. Good storability. Medium dormancy period.",
    ...
    image: "src/assets/images/kennebec.jpg",
  },
  {
    name: "Yukon Gold",
    description: "",
  ...
  },
  {
    ...
    image: "src/assets/images/yukonGold.jpg",
  },
  {
    name: "Potato",
    description: "",
    ...
    image: "src/assets/images/german.jpg",
  },
];
